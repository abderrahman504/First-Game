...
func find_destination():
	...
	x = GlobalReferences.randomNoGenerator.randi_range(xLowerBound, xUpperBound)
	...
	y = GlobalReferences.randomNoGenerator.randi_range(yLowerBound, yUpperBound)
